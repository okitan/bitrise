...
import { V0AppleAPICredentialsListResponse } from '../model/v0AppleAPICredentialsListResponse';
...
export enum AppleApiCredentialsApiApiKeys {
    PersonalAccessToken,
}

export class AppleApiCredentialsApi {
    ...
    public setApiKey(key: AppleApiCredentialsApiApiKeys, value: string) {
        (this.authentications as any)[AppleApiCredentialsApiApiKeys[key]].apiKey = value;
    }
    ...
    public async appleApiCredentialList (userSlug: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V0AppleAPICredentialsListResponse;  }> {
        ...
        if (userSlug === null || userSlug === undefined) {
            throw new Error('Required parameter userSlug was null or undefined when calling appleApiCredentialList.');
        }
            ...
            return new Promise<{ response: http.IncomingMessage; body: V0AppleAPICredentialsListResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "V0AppleAPICredentialsListResponse");
