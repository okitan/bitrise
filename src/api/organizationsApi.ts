...
import { V0OrganizationListRespModel } from '../model/v0OrganizationListRespModel';
import { V0OrganizationRespModel } from '../model/v0OrganizationRespModel';
...
export class OrganizationsApi {
            ...
            return new Promise<{ response: http.ClientResponse; body: V0OrganizationListRespModel;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "V0OrganizationListRespModel");
    ...
    public async orgShow (orgSlug: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: V0OrganizationRespModel;  }> {
        ...
        if (orgSlug === null || orgSlug === undefined) {
            throw new Error('Required parameter orgSlug was null or undefined when calling orgShow.');
        }
            ...
            return new Promise<{ response: http.ClientResponse; body: V0OrganizationRespModel;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "V0OrganizationRespModel");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
