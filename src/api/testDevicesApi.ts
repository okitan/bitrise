...
import { V0TestDeviceListResponseModel } from '../model/v0TestDeviceListResponseModel';
...
export enum TestDevicesApiApiKeys {
    AddonAuthToken,
    PersonalAccessToken,
}

export class TestDevicesApi {
    ...
    public setApiKey(key: TestDevicesApiApiKeys, value: string) {
        (this.authentications as any)[TestDevicesApiApiKeys[key]].apiKey = value;
    }
    ...
    public async testDeviceList (appSlug: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V0TestDeviceListResponseModel;  }> {
        ...
        if (appSlug === null || appSlug === undefined) {
            throw new Error('Required parameter appSlug was null or undefined when calling testDeviceList.');
        }
            ...
            return new Promise<{ response: http.IncomingMessage; body: V0TestDeviceListResponseModel;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "V0TestDeviceListResponseModel");
