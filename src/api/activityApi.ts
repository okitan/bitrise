...
import { V0ActivityEventListResponseModel } from '../model/v0ActivityEventListResponseModel';
            ...
            return new Promise<{ response: http.ClientResponse; body: V0ActivityEventListResponseModel;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "V0ActivityEventListResponseModel");
